...
If you do not want to use Theia, you can choose your own IDE including Eclipse, Visual Studio Code, Orion, or Atom IDE. To Microclimate, using your own IDE is just the same as using Theia - File Watcher continues to monitor your files for changes. Note: These options are applicable to a local installation of Microclimate only.
